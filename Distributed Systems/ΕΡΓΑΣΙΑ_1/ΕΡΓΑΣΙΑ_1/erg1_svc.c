...
{
	union {
		int_vector average_1_arg;
		int_vector max_min_1_arg;
		float_vector multiply_1_arg;
	} argument;
	char *result;
	...
	case AVERAGE:
		_xdr_argument = (xdrproc_t) xdr_int_vector;
	...
	case MAX_MIN:
		...
		local = (char *(*)(char *, struct svc_req *)) max_min_1_svc;
		break;

	case MULTIPLY:
		_xdr_argument = (xdrproc_t) xdr_float_vector;
		_xdr_result = (xdrproc_t) xdr_floatvec;
